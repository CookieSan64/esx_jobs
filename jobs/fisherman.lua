Config.Jobs.fisherman = {
	...
	Zones = {
		...
		BoatSpawnPoint = { --vector4(3861.507, 4473.448, -0.4748894, 227.3753)
			Pos   = {x = 3861.507, y = 4473.448, z = 0.0},
			Size  = {x = 0.8, y = 0.5, z = 1.0},
			Color = {r = 50, g = 200, b = 50},
			Marker= -1,
			Blip  = false,
		...
		BoatDeletePoint = {
			Pos   = {x = 3869.775, y = 4448.889, z = 1.3999216},
			Size  = {x = 0.8, y = 0.5, z = 1.0},
			Color = {r = 50, g = 200, b = 50},
			Marker= 20,
			Blip  = false,
			...
			Spawner = 2,
			Caution = 0,
			GPS = {x = 3869.775, y = 4448.889, z = 1.3999216},
		...
		VehicleDeletePoint = {
			Pos   = {x = 863.23, y = -1718.28, z = 29.63},
			Size  = {x = 0.8, y = 0.5, z = 1.0},
			Color = {r = 50, g = 200, b = 50},
			Marker= 20,
			Blip  = false,
